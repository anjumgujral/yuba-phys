...
# first scale all your climate variabels
trait_data2$def_30yr_mean_scaled <-
  scale(trait_data2$def_30yr_mean)

trait_data2$ppt_30yr_mean_scaled <-
  scale(trait_data2$ppt_30yr_mean)

trait_data2$aet_30yr_mean_scaled <-
  scale(trait_data2$aet_30yr_mean)

trait_data2$pet_30yr_mean_scaled <-
  scale(trait_data2$pet_30yr_mean)

trait_data2$vpd_30yr_mean_scaled <-
  scale(trait_data2$vpd_30yr_mean)

mod8 <- lmer(predawn_MPa_combined~ diameter_complete_scaled + canopy_closure_scaled + elevation_ft_scaled + def_30yr_mean_scaled + (1|plot) + (1|year), data = trait_data2)
summary(mod8)

plot(predawn_MPa_combined ~ def_30yr_normal, data = trait_data2)
```
