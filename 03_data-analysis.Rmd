...
# run this model for the following response variables: 'predawn_MPa_combined', 'midday_MPa_combined'
mod8 <- lmer(predawn_MPa_combined~ diameter_complete_scaled + canopy_closure_scaled + ppt_scaled + (1|plot) + (1|wp_year), data = trait_data2)
summary(mod8)
